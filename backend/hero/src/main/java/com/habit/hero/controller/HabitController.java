...
public class HabitController {
    ...
    // Bulk insert habits
    @PostMapping("/bulk")
    public ResponseEntity<List<HabitResponse>> bulkCreateHabits(@Valid @RequestBody HabitBulkCreateRequest request) {
        Long userId = currentUserUtil.getCurrentUserId();
        log.info("API: Bulk creating {} habits for user {}", request.getHabits().size(), userId);
