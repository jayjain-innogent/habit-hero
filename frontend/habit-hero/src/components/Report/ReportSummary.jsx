...
const ReportSummary = ({ summary, habitName }) => {
  return (
    <div className="report-summary">
      <h2>Overall Summary for {habitName}</h2>
      <div className="summary-cards">
        <div className="summary-card completion-rate">
          <div className="card-icon"><i class="bi bi-bar-chart-fill"></i></div>
        ...
        <div className="summary-card streak">
          <div className="card-icon"><i class="bi bi-fire"></i></div>
          <div className="card-content">
        ...
        <div className="summary-card missed-days">
          <div className="card-icon"><i class="bi bi-alarm-fill"></i></div>
          <div className="card-content">
            <h3>Missed Days</h3>
